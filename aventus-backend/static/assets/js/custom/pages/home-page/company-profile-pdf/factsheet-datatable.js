...
var DatatablesServerSide = function() {
            ...
            columnDefs: [
...

                {
                    ...
                    render: function(data, type, row) {                        
                        return `<div class="d-flex align-items-center">
                                    <div class="ms-5">
                                    <a href="${data}" target="_blank"><i class="fa-lg fa-solid fa-file" style="font-size: 24px; color: #828589;"></i></a>
                                    </div>
                                </div>`;
                    }
                },
              
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        if(data == 'True'){
                            label_badge_change = `<span style="cursor:pointer" data-id=${row.id}  class="btn btn-sm btn-outline btn-outline-dashed btn-outline-success btn-active-light-success active_inactive_company">Active</span>`;
                        }else if(data == 'False'){
                            label_badge_change =  `<span style="cursor:pointer" data-id=${row.id}  class="btn btn-sm btn-outline btn-outline-dashed btn-outline-danger btn-active-light-danger active_inactive_company">Inactive</span>`;
                        }
    ...
    var ActiveOrIncativeUser = ()=>{
        const activeButton = document.getElementsByClassName('active_inactive_company')
