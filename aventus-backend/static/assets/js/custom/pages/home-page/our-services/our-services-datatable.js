            ...
            columnDefs: [
                ...
                //IS MAIN
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        if(data == 'True'){
                            label_badge_change = `<span style="cursor:pointer" data-id=${row.id}  class="btn btn-sm btn-outline btn-outline-dashed btn-outline-success btn-active-light-success is_main_or_non_is_main_service ">Yes</span>`;
                        }else if(data == 'False'){
                            label_badge_change =  `<span style="cursor:pointer" data-id=${row.id}  class="btn btn-sm btn-outline btn-outline-dashed btn-outline-danger btn-active-light-danger is_main_or_non_is_main_service ">No</span>`;
                        }
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        let label_badge_change = '';
                        if(data == 'True'){
                            label_badge_change = `<span style="cursor:pointer" data-id=${row.id}  class="btn btn-sm btn-outline btn-outline-dashed btn-outline-success btn-active-light-success popular_or_non_popular_service ">Yes</span>`;
                        }else if(data == 'False'){
                            label_badge_change =  `<span style="cursor:pointer" data-id=${row.id}  class="btn btn-sm btn-outline btn-outline-dashed btn-outline-danger btn-active-light-danger popular_or_non_popular_service ">No</span>`;
                        }
                        return label_badge_change;
                    }
                },
...
//NAVBAR MAIN
var NavBarMani = ()=>{
    const activeButton = document.getElementsByClassName('is_main_or_non_is_main_service')
    activeButton.forEach(d => {
        d.addEventListener('click', function(e) {
            const activeId = $(this).data('id');
            e.preventDefault();
            Swal.fire({
                ...
                if(result.value){               
                    $.post(`${api_config.is_main_non_is_main_company}`, {id:activeId }, function(data, status, xhr) {
                        if (data.status_code == 200) {
                            Swal.fire({
                                text: "Successfully changed status ",
                                icon: "success",
...
//IS SUB
var IsSub = ()=>{
    const activeButton = document.getElementsByClassName('is_sub_or_non_is_sub_service')
    activeButton.forEach(d => {
        d.addEventListener('click', function(e) {
            const activeId = $(this).data('id');
            e.preventDefault();
            Swal.fire({
                ...
                if(result.value){               
                    $.post(`${api_config.is_sub_non_is_sub_company}`, {id:activeId }, function(data, status, xhr) {
                        if (data.status_code == 200) {
                            Swal.fire({
                                text: "Successfully changed status ",
                                icon: "success",
...
//IS BOTH
var IsBoth = ()=>{
    const activeButton = document.getElementsByClassName('is_both_or_non_is_both_service')
    activeButton.forEach(d => {
        d.addEventListener('click', function(e) {
            const activeId = $(this).data('id');
            e.preventDefault();
            Swal.fire({
                ...
                if(result.value){               
                    $.post(`${api_config.is_both_non_is_both_company}`, {id:activeId }, function(data, status, xhr) {
                        if (data.status_code == 200) {
                            Swal.fire({
                                text: "Successfully changed status ",
                                icon: "success",
...
//POPULAR OR NON POPULAR SECTION MANAGEMENT

var PopularOrNonPopularService = ()=>{
    const activeButton = document.getElementsByClassName('popular_or_non_popular_service')
    activeButton.forEach(d => {
        d.addEventListener('click', function(e) {
            const activeId = $(this).data('id');
            e.preventDefault();
            Swal.fire({
                ...
                if(result.value){               
                    $.post(`${api_config.popular_non_popular_company}`, {id:activeId }, function(data, status, xhr) {
                        if (data.status_code == 200) {
                            Swal.fire({
                                text: "Successfully changed status ",
                                icon: "success",
...
//POPULAR OR NON POPULAR SECTION MANAGEMENT END
