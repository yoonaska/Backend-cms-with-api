...
var DatatablesServerSide = function() {
            ...
            columnDefs: [
                ...
                // },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        <a href="javascript:void(0)" data-id=${row.id} data-customer-table-filter="delete_row" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
                            <span class="svg-icon svg-icon-3">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    var handleStatusFilter = () => {
        const filterStatus = document.querySelector('[data-customer-table-filter="status" ]');
    ...
    var handleDeleteRows = () => {
        ...
        const deleteButtons = document.querySelectorAll('[data-customer-table-filter="delete_row"]');
    ...
    var initToggleToolbar = function() {
        ...
        const container = document.querySelector('#customer-table');
        const checkboxes = container.querySelectorAll('[type="checkbox"]');

        // Select elements
        const deleteSelected = document.querySelector('[data-customer-table-select="delete_selected"]');
    ...
    var toggleToolbars = function() {
        ...
        const selectedCount = document.querySelector('[data-customer-table-select="selected_count"]');
