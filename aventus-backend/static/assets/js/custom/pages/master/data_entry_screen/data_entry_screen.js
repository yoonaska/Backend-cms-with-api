...
var DatatablesServerSide = function() {
    ...
    var initDatatable = function() {
        ...
        dt = $("#data_entry_screen-table").DataTable({
            searchDelay: 500,
            serverSide: true,
            responsive: false,
            processing: true,
    ...
    var handleSearchDatatable = function() {
        const filterSearch = document.querySelector('[data-data_entry_screen-table-filter="search" ]');
    ...
    var initToggleToolbar = function() {
        ...
        const container = document.querySelector('#data_entry_screen-table');
        const checkboxes = container.querySelectorAll('[type="checkbox"]');

        // Select elements
        const deleteSelected = document.querySelector('[data-data_entry_screen-table-select="delete_selected"]');
    ...
    var toggleToolbars = function() {
        ...
        const toolbarSelected = document.querySelector('[data-customer-table-toolbar="selected"]');
        const selectedCount = document.querySelector('[data-data_entry_screen-table-select="selected_count"]');
