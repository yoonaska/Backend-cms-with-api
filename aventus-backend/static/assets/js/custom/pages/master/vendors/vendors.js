...
var DatatablesServerSide = function() {
    ...
    var handleSearchDatatable = function() {
        const filterSearch = document.querySelector('[data-supplier-table-filter="search" ]');
    ...
    var initToggleToolbar = function() {
        ...
        const container = document.querySelector('#vendors-table');
        const checkboxes = container.querySelectorAll('[type="checkbox"]');

        // Select elements
        const deleteSelected = document.querySelector('[data-vendor-table-select="delete_selected"]');
    ...
    var toggleToolbars = function() {
        ...
        const toolbarSelected = document.querySelector('[data-vendor-table-toolbar="selected"]');
        const selectedCount = document.querySelector('[data-vendor-table-select="selected_count"]');
