...
var DatatablesServerSide = function() {
    ...
    var initDatatable = function() {
        ...
        dt = $("#worktype-data-table").DataTable({
            searchDelay: 500,
            serverSide: true,
            responsive: false,
            processing: true,
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        if(data == 'True'){
                            label_badge_change = `<span style="cursor:pointer" data-encrypt_id=${row.encrypt_id}  class="btn btn-sm btn-outline btn-outline-dashed btn-outline-success btn-active-light-success worktype_status">Active</span>`;
                        }else if(data == 'False'){
                            label_badge_change =  `<span style="cursor:pointer" data-encrypt_id=${row.encrypt_id}  class="btn btn-sm btn-outline btn-outline-dashed btn-outline-danger btn-active-light-danger worktype_status">Inactive</span>`;
                        }
    ...
    var handleStatusFilter = () => {
        const filterStatus = document.querySelector('[data-worktype-table-filter="status"  ]');
    ...
    var ActiveOrIncativeTaskManagement = ()=>{
        const activeButton = document.getElementsByClassName('worktype_status')
    ...
    var initToggleToolbar = function() {
        ...
        const container = document.querySelector('#worktype-data-table');
        const checkboxes = container.querySelectorAll('[type="checkbox"]');

        // Select elements
        const deleteSelected = document.querySelector('[data-worktype-table-select="delete_selected"]');
    ...
    var toggleToolbars = function() {
        ...
        const toolbarSelected = document.querySelector('[data-worktype-table-toolbar="selected"]');
        const selectedCount = document.querySelector('[data-worktype-table-select="selected_count"]');
