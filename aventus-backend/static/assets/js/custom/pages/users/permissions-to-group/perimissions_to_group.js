...
var DatatablesServerSide = function() {
    ...
    var initDatatable = function() {
        ...
        dt = $("#permissions-to-group-table").DataTable({
            searchDelay: 500,
            serverSide: true,
            responsive: false,
            processing: true,
            ...
            columnDefs: [
                ...
                // },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        <a href="javascript:void(0)" data-id=${row.id} data-supplier-table-filter="delete_row" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
                            <span class="svg-icon svg-icon-3">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    var handleSearchDatatable = function() {
        const filterSearch = document.querySelector('[data-permissions_to_group-table-filter="search" ]');
    ...
    var handleStatusFilter = () => {
        const filterStatus = document.querySelector('[data-supplier-table-filter="status" ]');
    ...
    var handleDeleteRows = () => {
        ...
        const deleteButtons = document.querySelectorAll('[data-supplier-table-filter="delete_row"]');
    ...
    var initToggleToolbar = function() {
        ...
        const container = document.querySelector('#permissions-to-group-table');
        const checkboxes = container.querySelectorAll('[type="checkbox"]');

        // Select elements
        const deleteSelected = document.querySelector('[data-permissions_to_group-select="delete_selected"]');
    ...
    var toggleToolbars = function() {
        ...
        const toolbarSelected = document.querySelector('[data-permissions_to_group-toolbar="selected"]');
        const selectedCount = document.querySelector('[data-permissions_to_group-select="selected_count"]');
